...
|---|---|---|---|---|---|
| 1 | `Sql.Database` | `rddhezwna3wutjobbbcron4k6e-vepdvwfqpavevgmawk5vs6h23e.database.fabric.microsoft.com` | `FoldingDemo-47385673-59b2-4c32-9e8e-4c383aa2b2a7` | 2 | **Yes** |
...
> **Overlapping source objects:** `dbo.Trip`  
> These identical source-level queries across models are strong candidates for a shared Dataflow or Lakehouse table.

---

## Datasource-to-Model Matrix

| Datasource |11-Solution-Sales Analysis | NYC Taxi - Folded | NYC Taxi - Not Folded | S&P Company Report | TableauWorkbooks |
|---|---|---|---|---|---|
| Sql.Database / rddhezwna3wutjobbbcron4k6e-vepdvwfqpavevgm... | — | ✅ (1 tables) | ✅ (1 tables) | — | — |
...
|---|---|---|---|
| 1 | Sql.Database / rddhezwna3wutjobbbcron4k6e-vepdv... | 2 | Consider a **Dataflow Gen2** to stage into a Lakehouse, or use **Direct Lake** with a mirrored database. |
...
*Generated by FabricDocGen — 2026-02-12T09:20:58-05:00*
